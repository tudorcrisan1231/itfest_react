                    ...
                    <div class="grid items-center justify-center max-w-4xl grid-cols-1 mx-auto lg:grid-cols-2 gap-x-16 gap-y-12">
                        <div>
                            <div class="max-w-lg mx-auto text-center lg:text-left lg:max-w-none lg:mx-0">
                                <h2 class="text-sm font-bold tracking-wide uppercase text-green-500">Food details</h2>
                                <p class="mt-4 text-5xl font-bold text-gray-900 md:text-6xl">Banana</p>
                                <p class="mt-6 text-md sm:text-lg font-medium text-gray-600 rounded-lg shadow-lg p-3 ">A banana is an elongated, edible fruit  botanically a berry  produced by several kinds of large herbaceous flowering plants in the genus Musa. In some countries, bananas used for cooking may be called "plantains", distinguishing them from dessert bananas.</p>
                            </div>
                            ...
                            <div class="max-w-xs mx-auto overflow-hidden bg-white  rounded-lg shadow-lg ">
                                <div class="p-4">
                                    ...
                                    <div class="mt-4 overflow-hidden rounded-lg aspect-w-1 aspect-h-1">
                                        <img class="object-cover w-full h-full" src="https://loe.org/content/2014-04-18/10-bananabunch.gif" alt="" />
                                    </div>

                                    <div class="flex items-center justify-between mt-4 space-x-6">
                                        <p class="flex text-base font-bold text-gray-900">Banana food</p>

                                        <div class="text-right shrink-0">
                                            <img class="object-cover w-auto h-10" src="https://static.openfoodfacts.org/images/attributes/dist/nutriscore-a.svg" alt="" />
                                        </div>
                                    </div>
