                    ...
                    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                        <div class="flex justify-between h-16 lg:h-[72px]">
                            ...
                            <div class="flex items-center justify-end ml-auto space-x-6">
                                ...
                                <a href='/my-food' class="hidden lg:inline-flex items-center justify-center text-white transition-all duration-200 bg-gray-900 rounded-full w-9 h-9 md:w-12 md:h-12 hover:bg-gray-700">
                ...
                {isMenuVisible && (
                    <div className={`fixed z-20 right-0 top-2 w-1/3 min-w-fit`}>
                        <nav className=" flex flex-col justify-center p-5 space-y-2 lg:hidden mt-14 shadow-lg bg-white bg-opacity-90 gap-3 rounded-b-xl">
                            ...
                            <a href="" onClick={toggleMenu} title="" className="flex justify-center transition-all duration-200 ease-out active:scale-110 p-2 text-base font-medium text-black focus:text-blue-600 rounded-xl bg-black bg-opacity-5 hover:bg-opacity-10"> Logout </a>
                        </nav>
                    </div>
                )}
