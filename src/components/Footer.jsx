      ...
      <>
        <footer class="py-12 bg-white sm:py-16 lg:py-20">
            <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <img class="w-auto h-16 mx-auto" src={logo} alt="" />

                <ul class="flex flex-wrap items-center justify-center space-x-12 md:space-x-16 mt-14">
                    <li>
                        <a href="#" title="" class="inline-flex text-lg font-medium text-gray-900 transition-all duration-200 transform font-pj hover:-translate-y-1 hover:text-gray-600"> 
                            Food
                         </a>
                    </li>
                ...
                <p class="text-base font-normal text-center text-gray-600 mt-7 font-pj">© Copyright 2024, All Rights Reserved</p>
            </div>
        </footer>
      </>
    )
